...
@section('main_content')
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Dashboard / Create New Schedule</h1>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            {!! Form::open(array('route' => 'dashboard.schedules.store','method'=>'POST')) !!}
                            <div class="row">
                                <div class="col-xs-12 col-sm-12 col-md-12 p-2">
                                    <div class="form-group">
                                        <strong>Title:</strong>
                                        {!! Form::text('title', null, array('placeholder' => 'Ttile','class' => 'form-control')) !!}
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-12 p-2">
                                    <div class="form-group">
